...
ActiveRecord::Schema.define(version: 20151110093404) do
  ...
  add_index "provides", ["book_id"], name: "index_provides_on_book_id"
  add_index "provides", ["user_id"], name: "index_provides_on_user_id"
